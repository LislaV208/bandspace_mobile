...
class MemberListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final displayName = member.name?.isNotEmpty == true ? member.name! : member.email;
    ...
    return Container(
      ...
      child: Row(
        children: [
          MemberAvatar(user: member, size: 40, borderWidth: 1),
          const Gap(12),
          Expanded(child: MemberInfo(displayName: displayName, subtitle: subtitle)),
        ],
      ),
    );
  }
