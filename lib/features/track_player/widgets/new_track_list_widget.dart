            ...
            return ListTile(
              ...
              onTap: () {
                if (track.mainVersion != null) {
                  context.read<TrackPlayerCubit>().selectTrack(index);
                }
              },
              trailing: isSelected && (state.playerUiStatus == PlayerUiStatus.playing || state.playerUiStatus == PlayerUiStatus.loading)
