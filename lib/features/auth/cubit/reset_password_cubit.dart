...
class ResetPasswordCubit extends Cubit<ResetPasswordState> {
  ...
  Future<void> requestPasswordReset() async {
    ...
    try {
      ...
      final response = await authRepository.forgotPassword(email: emailController.text.trim());
  ...
  Future<void> resetPassword() async {
    ...
    try {
      ...
      emit(
        state.copyWith(isLoading: false, step: ResetPasswordStep.completed, successMessage: Value(response.message)),
      );
  ...
  void goBack() {
    if (state.step == ResetPasswordStep.enterToken) {
      emit(state.copyWith(step: ResetPasswordStep.enterEmail, errorMessage: Value(null), successMessage: Value(null)));
